...
ax.hist((muons[1][:-1], NC[1][:-1], e[1][:-1], mu[1][:-1], tau[1][:-1]),
...
cutnames = [
   'with_simple_cuts', 'pure_track', 'pure_shower', 'contaminated_track', 'contaminated_shower' 
]
variables=[
    "True_E",
    "JG_E",
...
def make_datamc_hist(ax0, hists0, xlabel0, labels0, colors0):
    ...
    ax0.hist((muons0[1][:-1], NC0[1][:-1], e0[1][:-1], mu0[1][:-1], tau0[1][:-1]),
...
def make_datamc_hist_stacked(ax0, hists0, xlabel0, labels0, colors0):
    ...
    #mctotal0 = hists0[4]
    #ax0.hist((muons0[1][:-1], NC0[1][:-1], e0[1][:-1], mu0[1][:-1], tau0[1][:-1], mctotal0[1][:-1]),
    ax0.hist((muons0[1][:-1], tau0[1][:-1], NC0[1][:-1], e0[1][:-1], mu0[1][:-1]),
    #ax0.hist(( tau0[1][:-1], NC0[1][:-1], e0[1][:-1], mu0[1][:-1]),
    #ax0.hist(( tau0[1][:-1], NC0[1][:-1], e0[1][:-1], mu0[1][:-1], muons0[1][:-1]),
             #bins = muons0[1],
             bins = NC0[1],
