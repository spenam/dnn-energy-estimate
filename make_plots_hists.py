...
dataset = {
    'muons v7.2'         : {'filename':dst_files_directory+'/v7.2.mc.mupage_tuned.sirene.jorcarec.jsh.aanet.dst_merged.root'},
    'anu e CC high v7.2'      : {'filename':dst_files_directory+'/mcv7.2.gsg_anti-elec-CC_100-500GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'},
    'anu e CC low v7.2'       : {'filename':dst_files_directory+'/mcv7.2.gsg_anti-elec-CC_1-100GeV.km3sim.jorcarec.jsh.aanet.dst_merged.root'},
    'anu e CC higher v7.2'    : {'filename':dst_files_directory+'/mcv7.2.gsg_anti-elec-CCHEDIS_500-10000GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'},
    'anu mu CC high v7.2'     : {'filename':dst_files_directory+'/mcv7.2.gsg_anti-muon-CC_100-500GeV.km3sim.jorcarec.jsh.aanet.dst_merged.root'},
    'anu mu CC low v7.2'      : {'filename':dst_files_directory+'/mcv7.2.gsg_anti-muon-CC_1-100GeV.km3sim.jorcarec.jsh.aanet.dst_merged.root'}, 
    'anu mu CC higher v7.2'   : {'filename':dst_files_directory+'/mcv7.2.gsg_anti-muon-CCHEDIS_500-10000GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'},
    'anu mu NC high v7.2'     : {'filename':dst_files_directory+'/mcv7.2.gsg_anti-muon-NC_100-500GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'},
    'anu mu NC low v7.2'      : {'filename':dst_files_directory+'/mcv7.2.gsg_anti-muon-NC_1-100GeV.km3sim.jorcarec.jsh.aanet.dst_merged.root'},
    'anu mu NC higher v7.2'   : {'filename':dst_files_directory+'/mcv7.2.gsg_anti-muon-NCHEDIS_500-10000GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'},
    'anu tau CC high v7.2'    : {'filename':dst_files_directory+'/mcv7.2.gsg_anti-tau-CC_100-500GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'}, 
    'anu tau CC low v7.2'     : {'filename':dst_files_directory+'/mcv7.2.gsg_anti-tau-CC_3-100GeV.km3sim.jorcarec.jsh.aanet.dst_merged.root'},
    'nu e CC high v7.2'       : {'filename':dst_files_directory+'/mcv7.2.gsg_elec-CC_100-500GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'},
    'nu e CC low v7.2'        : {'filename':dst_files_directory+'/mcv7.2.gsg_elec-CC_1-100GeV.km3sim.jorcarec.jsh.aanet.dst_merged.root'},
    'nu e CC higher v7.2'     : {'filename':dst_files_directory+'/mcv7.2.gsg_elec-CCHEDIS_500-10000GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'},
    'nu mu CC high v7.2'     : {'filename':dst_files_directory+'/mcv7.2.gsg_muon-CC_100-500GeV.km3sim.jorcarec.jsh.aanet.dst_merged.root'},
    'nu mu CC low v7.2'      : {'filename':dst_files_directory+'/mcv7.2.gsg_muon-CC_1-100GeV.km3sim.jorcarec.jsh.aanet.dst_merged.root'},    
    'nu mu CC higher v7.2'   : {'filename':dst_files_directory+'/mcv7.2.gsg_muon-CCHEDIS_500-10000GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'},  
    'nu mu NC high v7.2'     : {'filename':dst_files_directory+'/mcv7.2.gsg_muon-NC_100-500GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'},
    'nu mu NC low v7.2'      : {'filename':dst_files_directory+'/mcv7.2.gsg_muon-NC_1-100GeV.km3sim.jorcarec.jsh.aanet.dst_merged.root'},
    'nu mu NC higher v7.2'   : {'filename':dst_files_directory+'/mcv7.2.gsg_muon-NCHEDIS_500-10000GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'},
    'nu tau CC high v7.2'    : {'filename':dst_files_directory+'/mcv7.2.gsg_tau-CC_100-500GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'}, 
    'nu tau CC low v7.2'     : {'filename':dst_files_directory+'/mcv7.2.gsg_tau-CC_3-100GeV.km3sim.jorcarec.jsh.aanet.dst_merged.root'},   

    'muons7X8X v7.1'         : {'filename':dst_files_directory+'/v7.1.mc.mupage_tuned.sirene.jorcarec.jsh.aanet.7X_8X_dst_merged.root'},
    'muons9X10X v7.1'         : {'filename':dst_files_directory+'/v7.1.mc.mupage_tuned.sirene.jorcarec.jsh.aanet.9X_10X_dst_merged.root'},
    'anu e CC high v7.1'      : {'filename':dst_files_directory+'/mcv7.1.gsg_anti-elec-CC_100-500GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'},
    'anu e CC low v7.1'       : {'filename':dst_files_directory+'/mcv7.1.gsg_anti-elec-CC_1-100GeV.km3sim.jorcarec.jsh.aanet.dst_merged.root'},
    'anu e CC higher v7.1'    : {'filename':dst_files_directory+'/mcv7.1.gsg_anti-elec-CCHEDIS_500-10000GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'},
...
#    'anu mu CC low v7.1'      : {'filename':dst_files_directory+'/mcv7.1.gsg_anti-muon-CC_1-100GeV.km3sim.jorcarec.jsh.aanet.dst_merged.root'}, 
    'anu mu CC higher v7.1'   : {'filename':dst_files_directory+'/mcv7.1.gsg_anti-muon-CCHEDIS_500-10000GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'},
    'anu mu NC high v7.1'     : {'filename':dst_files_directory+'/mcv7.1.gsg_anti-muon-NC_100-500GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'},
    'anu mu NC low v7.1'      : {'filename':dst_files_directory+'/mcv7.1.gsg_anti-muon-NC_1-100GeV.km3sim.jorcarec.jsh.aanet.dst_merged.root'},
    'anu mu NC higher v7.1'   : {'filename':dst_files_directory+'/mcv7.1.gsg_anti-muon-NCHEDIS_500-10000GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'},
...
#    'anu tau CC low v7.1'     : {'filename':dst_files_directory+'/mcv7.1.gsg_anti-tau-CC_3-100GeV.km3sim.jorcarec.jsh.aanet.dst_merged.root'},
    'nu e CC high v7.1'       : {'filename':dst_files_directory+'/mcv7.1.gsg_elec-CC_100-500GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'},
    'nu e CC low v7.1'        : {'filename':dst_files_directory+'/mcv7.1.gsg_elec-CC_1-100GeV.km3sim.jorcarec.jsh.aanet.dst_merged.root'},
    'nu e CC higher v7.1'     : {'filename':dst_files_directory+'/mcv7.1.gsg_elec-CCHEDIS_500-10000GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'},
...
#    'nu mu CC low v7.1'      : {'filename':dst_files_directory+'/mcv7.1.gsg_muon-CC_1-100GeV.km3sim.jorcarec.jsh.aanet.dst_merged.root'},    
    'nu mu CC higher v7.1'   : {'filename':dst_files_directory+'/mcv7.1.gsg_muon-CCHEDIS_500-10000GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'},  
    'nu mu NC high v7.1'     : {'filename':dst_files_directory+'/mcv7.1.gsg_muon-NC_100-500GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'},
    'nu mu NC low v7.1'      : {'filename':dst_files_directory+'/mcv7.1.gsg_muon-NC_1-100GeV.km3sim.jorcarec.jsh.aanet.dst_merged.root'},
    'nu mu NC higher v7.1'   : {'filename':dst_files_directory+'/mcv7.1.gsg_muon-NCHEDIS_500-10000GeV.sirene.jorcarec.jsh.aanet.dst_merged.root'},
...
dataset_data = {
    'data 7X'     : {'filename':dst_files_directory+'/datav7.1.jorcarec.jsh.aanet.7X_dst_merged.root'},
    'data 80'     : {'filename':dst_files_directory+'/datav7.1.jorcarec.jsh.aanet.80_dst_merged.root'},
    'data 85'     : {'filename':dst_files_directory+'/datav7.1.jorcarec.jsh.aanet.85_dst_merged.root'},
    'data 90'     : {'filename':dst_files_directory+'/datav7.1.jorcarec.jsh.aanet.90_dst_merged.root'},
    'data 95'     : {'filename':dst_files_directory+'/datav7.1.jorcarec.jsh.aanet.95_dst_merged.root'},
    'data 100X'     : {'filename':dst_files_directory+'/datav7.1.jorcarec.jsh.aanet.100X_dst_merged.root'},
    'data 110X'     : {'filename':dst_files_directory+'/datav7.1.jorcarec.jsh.aanet.110X_dst_merged.root'},
}

for key, items in dataset.items():                                    
    items["pipename"] = key       # Don't remember why but that's important  
    fname = items['filename'].split('/')[-1] # Get the DST filename to convert it into GNN file name  
    fname = 'outputTree_PID_' + fname + '.root'
    items['filename_friend'] = friend_files_directory +"/"+ fname.split('/')[-1]
    ...
    fname = items['filename'].split('/')[-1].split('.root')[0] # Get the DST filename to convert it into GNN file name  
    fname = fname + '_DNN.root'
    items['filename_friend2'] = friend_files_directory2 +"/"+ fname.split('/')[-1]
    #items['friend_trees'] = ['T',items['filename_friend']+':events']  # Tells the pump to load the tree "T" and "<path_to_the_file>:gnn", in addition to the E tree name":<dstfilepath>}``
    items['friend_trees'] = ['T',items['filename_friend']+':tree',items['filename_friend2']+':DNN']  # Tells the pump to load the tree "T" and "<path_to_the_file>:gnn", in addition to the E tree name":<dstfilepath>}``
...
manager.append_module("ant_pump", ka.AntPump, kwargs = {"step_size":1000000}, dataset_fields = {"filename":"filename",
                                                                                                "friend_trees":"friend_trees",
                                                                                                "pipename":"pipename"})
manager_data.append_module("ant_pump", ka.AntPump, kwargs = {"step_size":1000000}, dataset_fields = {"filename":"filename",
                                                                                                "friend_trees":"friend_trees",
                                                                                                "pipename":"pipename"})
#####################################################
# Exposure handler
...
manager.append_module("weighter", ka.eventWeighter, dataset_fields = {'ext_weight':'ext_weight'}, kwargs =
                      {'cst_weight':1})
manager_data.append_module("weighter", ka.eventWeighter, dataset_fields = {'ext_weight':'ext_weight'}, kwargs =
                      {'cst_weight':1})
#####################################################
# Adding some cuts
# ~~~~~~~~~~~~~~~~~~~~~
...
manager.append_module("pure_track",   ka.cutsHandler, kwargs = {"cuts":pure_track})
manager.append_module("pure_shower",   ka.cutsHandler, kwargs = {"cuts":pure_shower})
manager.append_module("contaminated_track",   ka.cutsHandler, kwargs = {"cuts":contaminated_track})
manager.append_module("contaminated_shower",   ka.cutsHandler, kwargs = {"cuts":contaminated_shower})
manager_data.append_module("without",   ka.cutsHandler, kwargs = {"cuts":without})
manager_data.append_module("my_simple_cuts",   ka.cutsHandler, kwargs = {"cuts":cuts})
manager_data.append_module("pure_track",   ka.cutsHandler, kwargs = {"cuts":pure_track})
manager_data.append_module("pure_shower",   ka.cutsHandler, kwargs = {"cuts":pure_shower})
manager_data.append_module("contaminated_track",   ka.cutsHandler, kwargs = {"cuts":contaminated_track})
manager_data.append_module("contaminated_shower",   ka.cutsHandler, kwargs = {"cuts":contaminated_shower})
...
mc_hists = [
        ...
        ka.histogram('trueEnergy_vs_JG_E',     
                                  ['E.mc_trks.E[:,0]','E.trks.E[:,0]'],     
                                  [10**np.linspace(0,4,41), 10**np.linspace(0,4,41)]),     

        ka.histogram('trueEnergy_vs_JG_Len',     
                     ['E.mc_trks.E[:,0]','E.trks.len[:,0]*0.25'],     
                                      [10**np.linspace(0,4,41), 10**np.linspace(0,4,41)]),
        ka.histogram('trueEnergy_vs_JS_E',     
                                  ['E.mc_trks.E[:,0]','E.trks.E[:,1]'],     
                                  [10**np.linspace(0,4,41), 10**np.linspace(0,4,41)]),     
        ka.histogram('trueEnergy_vs_DNN_Eest',     
...
manager.append_module("mc_hists_without_cuts",
                                            ka.histogramHandler, 
                                            kwargs = {'histograms':mc_hists, 'rate_hists':True})


manager.append_module("mc_hists_with_simple_cuts",
                                            ka.histogramHandler, 
                                            kwargs = {'mask_name':'my_simple_cuts','histograms':mc_hists,
                                                      'rate_hists':True})

manager.append_module("mc_hists_pure_track",
                                            ka.histogramHandler, 
                                            kwargs = {'mask_name':'pure_track','histograms':mc_hists,
                                                      'rate_hists':True})
manager.append_module("mc_hists_pure_shower",
                                            ka.histogramHandler, 
                                            kwargs = {'mask_name':'pure_shower','histograms':mc_hists,
                                                      'rate_hists':True})
manager.append_module("mc_hists_contaminated_track",
                                            ka.histogramHandler, 
                                            kwargs = {'mask_name':'contaminated_track','histograms':mc_hists,
                                                      'rate_hists':True})
manager.append_module("mc_hists_contaminated_shower",
                                            ka.histogramHandler, 
                                            kwargs = {'mask_name':'contaminated_shower','histograms':mc_hists,
                                                      'rate_hists':True})

manager_data.append_module("data_hists_without_cuts",
                                            ka.histogramHandler, 
                                            kwargs = {'histograms':data_hists, 'rate_hists':True})


manager_data.append_module("data_hists_with_simple_cuts",
                                            ka.histogramHandler, 
                                            kwargs = {'mask_name':'my_simple_cuts','histograms':data_hists,
                                                      'rate_hists':True})

manager_data.append_module("data_hists_pure_track",
                                            ka.histogramHandler, 
                                            kwargs = {'mask_name':'pure_track','histograms':data_hists,
                                                      'rate_hists':True})
manager_data.append_module("data_hists_pure_shower",
                                            ka.histogramHandler, 
                                            kwargs = {'mask_name':'pure_shower','histograms':data_hists,
                                                      'rate_hists':True})
manager_data.append_module("data_hists_contaminated_track",
                                            ka.histogramHandler, 
                                            kwargs = {'mask_name':'contaminated_track','histograms':data_hists,
                                                      'rate_hists':True})
manager_data.append_module("data_hists_contaminated_shower",
                                            ka.histogramHandler, 
                                            kwargs = {'mask_name':'contaminated_shower','histograms':data_hists,
                                                      'rate_hists':True})
...
sub_menu = [                                                                                                                                                                                                       
        ...
        [['nu e CC tot v7.2','+','nu mu CC tot v7.2','+','nu mu NC tot v7.2', '+', 'nu tau CC tot v7.2'], 'nu total v7.2'],  
        [['nu total v7.2','+','muons v7.2',], 'mc total v7.2'],   
