...
https://git.km3net.de/spenamartinez/dnn_energy_estimate/issues

You can browse all the issues here: https://git.km3net.de/spenamartinez/dnn_energy_estimate/issues
...
Check out our KanBan board https://git.km3net.de/spenamartinez/dnn_energy_estimate/boards,
...
Go to https://git.km3net.de/spenamartinez/dnn_energy_estimate and click on "Fork".

After that, you will have a full copy of the code with write access under an URL
like this: ``https://git.km3net.de/YOUR_USERNAME/dnn_energy_estimate``
...
Get a local copy to work on (use the SSH address `git@git...`, not the HTTP one)::
    ...
    git clone git@git.km3net.de:YOUR_USERNAME/dnn_energy_estimate
...
own fork with the original repository::
    ...
    git remote add upstream https://git.km3net.de/spenamartinez/dnn_energy_estimate
...
Go to https://git.km3net.de/spenamartinez/dnn_energy_estimate/merge_requests/new and select your
