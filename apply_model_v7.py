...
outFileName = (
    outFilePath + "hist_" + outFileExtension + ".root"
...
for key, items in dataSets.items():
    ...
    items["friend_trees"] = [
        "T"
    ]  # Tells the pump to load the tree "T" and "<path_to_the_file>:gnn", in addition to the E tree
...
for key, value in dataSets.items():
    ...
    print(outFilePath)
    print(key.replace(" ", "-"))
    value["output_filename"] = "{}/{}_{}.root".format(
...
manager.append_module(
    ...
    apply_model,
    kwargs={  # std
        "input_dir": "/sps/km3net/users/spenamar/hackathon/tf/training_workflow/models_w/32_32_32_32_32_32_32_32_32_32_32_32_log_cosh_v7.10_jshf__w_15_1e-05.h5",
        "output_key": "energy_recoDNN",
        "pwd": ".",
    },
)
...
manager.append_module(
    ...
    kwargs={"masks": [], "branches": ["energy_recoDNN"], "treename": "DNN"},
)
