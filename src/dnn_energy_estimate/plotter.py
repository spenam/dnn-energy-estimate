...
def get_unbiasing_factor(x_array, y_array, histweights):
    ...
    factor_function = interp1d(
        midEbins, hbin_dE / midEbins, fill_value=(1, 1), bounds_error=False
    )
...
def do_2dcorr(
    ...
    ax0.hist2d(x_array, y_array, weights=histweights,
               bins=[Ebins, Ebins], cmin=cmin)
