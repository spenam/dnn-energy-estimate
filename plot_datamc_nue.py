...
def make_datamc_hist(ax0, hists0, xlabel0, labels0, colors0):
    ...
    ax0.hist(
        (tau0[1][:-1], NC0[1][:-1], e0[1][:-1], mu0[1][:-1]),
        # bins = muons0[1],
        bins=NC0[1],
...
datasets = {
    "JG_E_vs_trueEnergy_simple": {
        ...
        "histpath": "mc_hists_with_simple_cuts/trueEnergy_vs_JG_E/nu e CC tot",
        "label": "JEnergy",
    },
    "JG_Len_vs_trueEnergy_simple": {
        "filename": "mc_hists_v7.2.root",
        "histpath": "mc_hists_with_simple_cuts/trueEnergy_vs_JG_Len/nu e CC tot",
        "label": "JStart",
    },
    "JS_E_vs_trueEnergy_simple": {
        "filename": "mc_hists_v7.2.root",
        "histpath": "mc_hists_with_simple_cuts/trueEnergy_vs_JS_E/nu e CC tot",
        "label": "JShF",
    },
    "DNN_Eest_vs_trueEnergy_simple": {
        "filename": "mc_hists_v7.2.root",
        "histpath": "mc_hists_with_simple_cuts/trueEnergy_vs_DNN_Eest/nu e CC tot",
        "label": "Eest",
    },
    "JG_E_vs_trueEnergy_pure_track": {
        "filename": "mc_hists_v7.2.root",
        "histpath": "mc_hists_pure_track/trueEnergy_vs_JG_E/nu e CC tot",
        "label": "JEnergy",
    },
    "JG_Len_vs_trueEnergy_pure_track": {
        "filename": "mc_hists_v7.2.root",
        "histpath": "mc_hists_pure_track/trueEnergy_vs_JG_Len/nu e CC tot",
        "label": "JStart",
    },
    "JS_E_vs_trueEnergy_pure_track": {
        "filename": "mc_hists_v7.2.root",
        "histpath": "mc_hists_pure_track/trueEnergy_vs_JS_E/nu e CC tot",
        "label": "JShF",
    },
    "DNN_Eest_vs_trueEnergy_pure_track": {
        "filename": "mc_hists_v7.2.root",
        "histpath": "mc_hists_pure_track/trueEnergy_vs_DNN_Eest/nu e CC tot",
        "label": "Eest",
    },
    "JG_E_vs_trueEnergy_pure_shower": {
        "filename": "mc_hists_v7.2.root",
        "histpath": "mc_hists_pure_shower/trueEnergy_vs_JG_E/nu e CC tot",
        "label": "JEnergy",
    },
    "JG_Len_vs_trueEnergy_pure_shower": {
        "filename": "mc_hists_v7.2.root",
        "histpath": "mc_hists_pure_shower/trueEnergy_vs_JG_Len/nu e CC tot",
        "label": "JStart",
    },
    "JS_E_vs_trueEnergy_pure_shower": {
        "filename": "mc_hists_v7.2.root",
        "histpath": "mc_hists_pure_shower/trueEnergy_vs_JS_E/nu e CC tot",
        "label": "JShF",
    },
    "DNN_Eest_vs_trueEnergy_pure_shower": {
        "filename": "mc_hists_v7.2.root",
        "histpath": "mc_hists_pure_shower/trueEnergy_vs_DNN_Eest/nu e CC tot",
        "label": "Eest",
    },
    "JG_E_vs_trueEnergy_contaminated_track": {
        "filename": "mc_hists_v7.2.root",
        "histpath": "mc_hists_contaminated_track/trueEnergy_vs_JG_E/nu e CC tot",
        "label": "JEnergy",
    },
    "JG_Len_vs_trueEnergy_contaminated_track": {
        "filename": "mc_hists_v7.2.root",
        "histpath": "mc_hists_contaminated_track/trueEnergy_vs_JG_Len/nu e CC tot",
        "label": "JStart",
    },
    "JS_E_vs_trueEnergy_contaminated_track": {
        "filename": "mc_hists_v7.2.root",
        "histpath": "mc_hists_contaminated_track/trueEnergy_vs_JS_E/nu e CC tot",
        "label": "JShF",
    },
    "DNN_Eest_vs_trueEnergy_contaminated_track": {
        "filename": "mc_hists_v7.2.root",
        "histpath": "mc_hists_contaminated_track/trueEnergy_vs_DNN_Eest/nu e CC tot",
        "label": "Eest",
    },
    "JG_E_vs_trueEnergy_contaminated_shower": {
        "filename": "mc_hists_v7.2.root",
        "histpath": "mc_hists_contaminated_shower/trueEnergy_vs_JG_E/nu e CC tot",
        "label": "JEnergy",
    },
    "JG_Len_vs_trueEnergy_contaminated_shower": {
        "filename": "mc_hists_v7.2.root",
        "histpath": "mc_hists_contaminated_shower/trueEnergy_vs_JG_Len/nu e CC tot",
        "label": "JStart",
    },
    "JS_E_vs_trueEnergy_contaminated_shower": {
        "filename": "mc_hists_v7.2.root",
        "histpath": "mc_hists_contaminated_shower/trueEnergy_vs_JS_E/nu e CC tot",
        "label": "JShF",
    },
    "DNN_Eest_vs_trueEnergy_contaminated_shower": {
        "filename": "mc_hists_v7.2.root",
        "histpath": "mc_hists_contaminated_shower/trueEnergy_vs_DNN_Eest/nu e CC tot",
        "label": "Eest",
    },
}
...
plt.tight_layout()
plt.grid(True)
plt.savefig("pre_cuts_nue.png")
plt.savefig("pre_cuts_nue.pdf")
plt.show()
...
plt.tight_layout()
plt.grid(True)
plt.savefig("pure_track_nue.png")
plt.savefig("pure_track_nue.pdf")
plt.show()
...
plt.tight_layout()
plt.grid(True)
plt.savefig("pure_shower_nue.png")
plt.savefig("pure_shower_nue.pdf")
plt.show()
...
plt.tight_layout()
plt.grid(True)
plt.savefig("contaminated_track_nue.png")
plt.savefig("contaminated_track_nue.pdf")
plt.show()
...
plt.tight_layout()
plt.grid(True)
plt.savefig("contaminated_shower_nue.png")
plt.savefig("contaminated_shower_nue.pdf")
plt.show()
